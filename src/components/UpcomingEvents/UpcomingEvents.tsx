...
export const UPCOMING_EVENTS = [
  {
    title: 'این یکشنبه گردهمایی حضوری برگزار نمی‌شود',
    date: '29',
    month: 'dec',
    description: 'به کلیسای آنلاین ما بپیوندید!',
  },
  {
    title: 'گردهمایی عیسی برای شهر آرورا',
    date: '05',
    month: 'jan',
    description: 'یک گردهمایی ویژه برای تقویت ایمان و ایجاد اتحاد در میان جامعهٔ آرورا، با محوریت پیام عشق و امید عیسی مسیح.',
  },
  {
    title: 'به کلیسا خوش آمدید',
    date: '12',
    month: 'jan',
    description: 'خوش آمدید به کلیسای PIWC Aurora! اینجا جایی است برای رشد در ایمان، تجربهٔ حضور خداوند و ارتباط با جامعه‌ای که همگی با هم در مسیر پیروی از عیسی گام برمی‌داریم',
  },
  {
    title: 'شب جمعی',
    date: '21',
    month: 'jan',
    description:
      'شب جمعی فرصتی است برای جمع شدن به‌عنوان یک جامعه، پرستش خداوند و تقویت ارتباطات معنوی. در این شب، با هم به رشد در ایمان و هم‌افزایی در مسیر پیروی از عیسی خواهیم پرداخت',
  },
  {
    title: 'گوش بدهید و بیاموزید',
    date: '28',
    month: 'jan',
    description:
      'در این برنامه، فرصتی برای یادگیری و رشد در ایمان فراهم می‌شود. با گوش دادن به آموزه‌ها و سخنرانی‌های عمیق، شما می‌توانید بیشتر درک کنید که چگونه می‌توانید در زندگی روزمره خود از اصول مسیحی پیروی کنید.',
  },
]
